...
const ReferCards = ({ img, heading, text }: { img: string; heading: string; text: string }) => {
   return (
      <div className="relative xl:w-[calc((100vw-10em)/3)] lg:w-[calc((100vw-8em)/3)] max-[700px]:w-[calc((100vw-40px))] w-[calc((100vw-5em)/2)] 2xl:h-160 xl:h-125 lg:h-[28em] max-lg:h-135 max-[850px]:h-120! max-[700px]:h-150! max-[450px]:h-120! ">
         <div className="w-full" style={{ paddingTop: "125%" }}>
            <div className="w-full h-full absolute bg-black/15 top-0 z-40" />
            <Image src={img || "/Dummy/Home/Refer1.png"} alt="Category Image Here" layout="fill" className="object-cover" />
